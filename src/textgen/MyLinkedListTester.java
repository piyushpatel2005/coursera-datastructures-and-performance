...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		assertEquals("AddEnd: Check return value is correct ",  true, shortList.add("C"));
		assertEquals("AddEnd: Check added value is correct ",  "C", shortList.get(2));
		assertEquals("AddEnd: Check size is updated ",  3, shortList.size());
	}
